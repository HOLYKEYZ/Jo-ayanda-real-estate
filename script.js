...
let properties = [
    {
        ...
        description: "Luxurious 4-bedroom bungalow facing tarred road with excellent proximity to major places in GRA. Document: C of O.",
    ...
    },
    {
        ...
        description: "Last 85m, reason is this it comes with all 10 AC, the 27kv generator and the car porch. Total land is 4 plots, main house has 5 bedrooms, joined BQ has 2 bedrooms. It has C of O.",
    ...
    },
    {
        ...
        description: "This land is located near kanbi olorobo estate, Ilorin. It is a good land for investment, estate and farming activities",
    ...
    },
    {
        ...
        description: "Elegant 4-bedroom duplex with modern amenities, located in a quiet residential area.",
        location: "Enyekorin, Kwara",
        price: "₦40M",
        type: "house",
        status: "sale",
        beds: 4,
        ...
        amenities: ["Modern Amenities", "Quiet Area"],
        yearBuilt: 2021,
        area: "Enyekorin"
    },
    {
        ...
        description: "Modern Duplex and solid structure with high commercial structures, located at tanke area.",
...
const searchManager = {
    ...
    setupSearchSuggestions() {
        ...
        const suggestions = [
            'GRA Ilorin', 'Airport Road', 'Tanke', 'Enyekorin', 
            'Mandate Market', 'Oke-Oyi', '4 Bedroom', '5 Bedroom',
            'Duplex', 'Land', 'Investment', 'Commercial'
        ];

        elements.searchInput.addEventListener('input', (e) => {
            const value = e.target.value.toLowerCase();
            if (value.length > 1) {
                this.showSuggestions(suggestions.filter(s => s.toLowerCase().includes(value)));
            } else {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        notifications.show('Welcome to JO Ayanda Real Estate Solutions!', 'info', 3000);
    }, 1000);
});
...
const adminPanel = {
    ...
    addNewProperty() {
        ...
        if (newProperty.beds > 0) newProperty.features.push(`${newProperty.beds} Beds`);
        if (newProperty.baths > 0) newProperty.features.push(`${newProperty.baths} Baths`);
...
function createPropertyCard(property) {
    ...
    card.innerHTML = `
        <div class="property-image">
            ...
            <div class="property-status ${statusClass}">For ${property.status === 'sale' ? 'Sale' : 'Rent'}</div>
...
function initializeAnimations() {
    ...
    const animateElements = document.querySelectorAll('.property-card, .service-item, .service-card, .contact-item');
