...
export const defaultProperties: Property[] = [
  ...
  },
  {
    ...
    description:
      "Almost completed property — 4 flats of 3 bedrooms each on 1 full plot. Located behind Typer Garage, Tanke, Ilorin South LGA, Kwara State, Nigeria. Survey plan available. Documents include: Deed of Assignment, Survey Plan, and Building Approval.",
